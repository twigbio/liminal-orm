...
def upgrade(
    ...
    liminal_entity = benchling_service.upsert_remote_revision_id(upgrade_revision_id)
...
def downgrade(
    ...
    liminal_entity = benchling_service.upsert_remote_revision_id(downgrade_revision_id)
    if local_revision_id_exists:
